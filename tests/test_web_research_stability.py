...
class TestAcronymResolver:
    ...
    def test_is_acronym(self):
        from acronym_resolver import is_acronym
...
class TestDuckDuckGoRetry:
    @patch("web_research.DDGS")
    @patch("web_research.time.sleep")
...
class TestResearchCache:
    def test_cache_hit(self):
        from web_research import WebResearchEngine, _RESEARCH_CACHE
        engine = WebResearchEngine()
